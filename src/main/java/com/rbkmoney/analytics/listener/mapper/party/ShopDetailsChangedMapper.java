...
public class ShopDetailsChangedMapper extends AbstractClaimChangeMapper<ShopRow> {
    ...
    private ShopRow mapEvent(MachineEvent event, ClaimEffect effect) {
        ...
        shopRow.setDetailsName(detailsChanged.getName());
        shopRow.setDetailsDescription(detailsChanged.getDescription());
