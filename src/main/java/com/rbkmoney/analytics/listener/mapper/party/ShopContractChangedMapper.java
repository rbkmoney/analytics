...
public class ShopContractChangedMapper extends AbstractClaimChangeMapper<ShopRow> {
    ...
    private ShopRow mapEvent(MachineEvent event, ClaimEffect effect) {
        ...
        shopRow.setContractId(contractChanged.getContractId());
        shopRow.setPayoutToolId(contractChanged.getPayoutToolId());
